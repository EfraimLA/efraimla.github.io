<svg class="{$$restProps.class || ''}" version='1.1' height='106' width='106' xmlns='http://www.w3.org/2000/svg'
		 xmlns:xlink='http://www.w3.org/1999/xlink'>
	<g id='logo' transform='translate(53, 53)'>
		<path id='r' transform='translate(0.5, 0.5)' stroke='black' stroke-width='1' stroke-linejoin='round'
